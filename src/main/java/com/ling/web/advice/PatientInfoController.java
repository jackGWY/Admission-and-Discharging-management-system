...
public class PatientInfoController {		//病人信息
	...
	@Autowired
	private ICcheckService iCcheckService;//检查信息
	...
	@RequestMapping("discharge_check")
	public ModelAndView discharge_check(HttpSession httpSession){//	  病人信息---基础信息 + 留院观察---入院资料---基础信息
		ModelAndView mv=new ModelAndView("/inpatient/discharge_check");
		return mv;
	}
