...
<li class="sidebar-nav-link">
	...
	<ul class="sidebar-nav sidebar-nav-sub">
		...
		<li class="sidebar-nav-link" onClick="Method('/patientInfo/patientmedical_allergy.do')"><a href="javascript:;" class="left-link"> 
		...
		<li class="sidebar-nav-link" onClick="Method('/patientInfo/patientmedical_disease.do')"><a href="javascript:;" class="left-link"> 
			...
			<li class="sidebar-nav-link" onClick="Method('/patientInfo/patientmedical_health.do')"><a href="javascript:;" class="left-link"> 
...
<li class="sidebar-nav-link">
	...
	<ul class="sidebar-nav sidebar-nav-sub">
		<li class="sidebar-nav-link" onClick="Method('/diagnosis/patientmedical_medical.do')"><a href="javascript:;" class="left-link"> 
			<span class="am-icon-angle-right sidebar-nav-link-logo"></span> 病      历 </a></li>
		<li class="sidebar-nav-link" onClick="Method('/diagnosis/patientmedical_diagnosis.do')"><a href="javascript:;" class="left-link"> 
			<span class="am-icon-angle-right sidebar-nav-link-logo"></span> 诊      断 </a></li>
		<li class="sidebar-nav-link" onClick="Method('/diagnosis/patientmedical_advice.do')"><a href="javascript:;" class="left-link"> 
			<span class="am-icon-angle-right sidebar-nav-link-logo"></span> 医      嘱 </a></li>
		<li class="sidebar-nav-link" onClick="Method('/diagnosis/patientmedical_test_apply.do')"><a href="javascript:;" class="left-link"> 
			<span class="am-icon-angle-right sidebar-nav-link-logo"></span> 检验申请 </a></li>
		<li class="sidebar-nav-link" onClick="Method('/diagnosis/patientmedical_check_apply.do')"><a href="javascript:;" class="left-link"> 
			<span class="am-icon-angle-right sidebar-nav-link-logo"></span>	检查申请 </a></li>
		<li class="sidebar-nav-link" onClick="Method('/diagnosis/patientmedical_operation.do')"><a href="javascript:;" class="left-link"> 
